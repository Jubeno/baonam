...
@Form.create()
@injectIntl
class ShortCutSelecGroupProducers extends Component {
  state = {
        ...
        dispatch({
          ...
          callback: (result) => {
            if (result && result.success === true) {
              ...
              message.success(intl.formatMessage({ id: 'app.common.create.success' }, { name: 'nhóm nhà sản xuất' }));
              setTimeout(() => {
                this.setState({
                  modalVisible: false,
                  spinning: false
    ...
    return (
      <React.Fragment>
        <Row gutter={{ md: 6 }}>
          ...
          <Col span={1}>
            <Tooltip title="Thêm nhanh nhóm nhà sản xuất">
        ...
        <Spin spinning={spinning}>
          <Modal
            destroyOnClose
            title="Thêm nhanh nhóm nhà sản xuất"
          ...
          >
            ...
            >
              ...
              })(<Input placeholder='Nhập tên nhóm nhà sản xuất' />)}
            </FormItem>
          </Modal>
        </Spin>
      </React.Fragment>
...
export default ShortCutSelecGroupProducers;
