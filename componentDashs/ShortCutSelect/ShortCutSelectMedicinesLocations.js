...
@Form.create()
@injectIntl
class ShortCutSelectMedicinesLocations extends Component {
  state = {
        ...
        dispatch({
          ...
          callback: (result) => {
            if (result && result.success === true) {
              ...
              message.success(intl.formatMessage({ id: 'app.common.create.success' }, { name: 'vị trí thuốc' }));
              setTimeout(() => {
                this.setState({
                  modalVisible: false,
                  spinning: false
    ...
    return (
      <React.Fragment>
        <Row gutter={{ md: 6 }}>
          ...
          <Col span={1}>
            <Tooltip title="Thêm nhanh vị trí thuốc">
        ...
        <Spin spinning={spinning}>
          ...
          >
            ...
            >
              ...
              })(<Input placeholder='Nhập tên vị trí thuốc' />)}
            </FormItem>
          </Modal>
        </Spin>
      </React.Fragment>
...
export default ShortCutSelectMedicinesLocations;
