...
@Form.create()
@injectIntl
class ShortCutSelectGroupSuppliers extends Component {
  state = {
        ...
        dispatch({
          ...
          callback: (result) => {
            if (result && result.success === true) {
              ...
              message.success(intl.formatMessage({ id: 'app.common.create.success' }, { name: 'nhóm nhà cung cấp' }));
              setTimeout(() => {
                this.setState({
                  modalVisible: false,
                  spinning: false
    ...
    return (
      <React.Fragment>
        <Row gutter={{ md: 6 }}>
          ...
          <Col span={1}>
            <Tooltip title="Thêm nhanh nhóm nhà cung cấp">
        ...
        <Spin spinning={spinning}>
          <Modal
            destroyOnClose
            title="Thêm nhanh nhóm nhà cung cấp"
          ...
          >
            ...
            >
              ...
              })(<Input placeholder='Nhập tên nhóm nhà cung cấp' />)}
            </FormItem>
          </Modal>
        </Spin>
      </React.Fragment>
...
export default ShortCutSelectGroupSuppliers;
