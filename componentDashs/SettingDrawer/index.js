...
class SettingDrawer extends PureComponent {
  ...
  getLayoutSetting = () => {
    ...
    return [
      {
        title: 'app.setting.content-width',
        action: (
          <Select
            value={contentWidth}
            size="small"
      ...
      {
        title: 'app.setting.hideheader',
        disabled: !fixedHeader,
        disabledReason: 'app.setting.hideheader.hint',
        action: (
          <Switch
            size="small"
      ...
      {
        title: 'app.setting.fixedsidebar',
        disabled: layout === 'topmenu',
        disabledReason: 'app.setting.fixedsidebar.hint',
        action: (
          <Switch
            size="small"
            checked={!!fixSiderbar}
    ...
    return (
      ...
      >
        <div className={styles.content}>
          <Body title='app.setting.pagestyle'>
            <BlockChecbox
              list={[
                {
                  key: 'dark',
          ...
          <Body title='app.setting.navigationmode'>
            <BlockChecbox
              list={[
                {
                  key: 'sidemenu',
          ...
          <Body title='app.setting.othersettings'>
            <List.Item
              actions={[
                <Switch
                  size="small"
