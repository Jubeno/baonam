...
class Index extends Component {
  ...
  onChange = (value) => {
    ...
    const { onChange, packages } = this.props;
    let data = packages && packages.filter(item => item.id === value)
  ...
  render() {
    const { key, placeholder, disabled, style } = this.props;
