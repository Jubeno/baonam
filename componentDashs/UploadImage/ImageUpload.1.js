...
class ImageUpload extends React.Component {
  ...
  resetImageEditor = () => {
    const { editorId } = this;
    console.log("editorId: %o, iframe: %o", editorId, document.getElementsByName(`myIframe-${editorId}`)[0].contentWindow)
  ...
  preloadImages(dropzone) {
    ...
    console.log("preloadImages screenShoots: ", screenShoots)
