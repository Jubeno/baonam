...
class BoxHot extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
  ...
  render() {
    ...
    return (
      <React.Fragment>
        {
          allProducts.payload && allProducts.payload.length > 0 &&
                ...
                <div className="row">
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div className="title_module_main">
                      <h2>
                        <a style={{ color: '#575454' }}><FormattedMessage id='product.highlights' /></a>
                      </h2>
                    </div>
                  </div>
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div className="wrap_owl">
                      <div className="owl-carousel owl-hotdeals" data-xs-items="2">
                        {
                         allProducts.payload && allProducts.payload.map(item => {
                            return (
